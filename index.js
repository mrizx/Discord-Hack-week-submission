...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Submisson- Script By : Mrzizx`);
        console.log(`----------------`);
...
//credits commadn / Economy system
...
var x2 = ['5587' ,' 9978' , '3785' , '7734' , '9864' , '7681' , '3758' , '7834' , '3489' , '1382' , '7389' , '8762' , '0889' , '0388' , '3316' , '0976' , '8603' , '1842' , '4565' , '9524' , '9524' , '0964' , '5930' , '5678' , '9567' , '6099' , '7058' , '0001' , '1324' , '9834' , '7668' , '0378' , '7055' , '9733' , '9876' , '9846' , '9685' , '8574' , '8975' , '9845' , '9862' , '0069' , '0807' , '0673' , '0813' , '1235' , '6879'];
        ...
        message.channel.send(` \`${args}\`** : Credits**  \n \`${x[x3]}\` ** :Type The following Number to procced **`).then(msg1=> { 
...
//avatar command need ability to send links
client.on('message', message => {
 if(message.author.bot) return;
...
//Simple Clear Code With Number Of messages
client.on('message', function(message) {
 if(message.author.bot) return;
    if(!message.channel.guild) return;
    if (message.author.bot) return;
...
client.on('message',async message => {
  ...
  if(message.content.startsWith(prefix + "giveaway")) {
     //return message.channel.send(':heavy_multiplication_x:| **This command is turned off.. ``Try Again Later``**');
...
client.on('message', message => {
    if(message.content.startsWith(prefix + 'new')) {
        ...
        if(!args) {
            return message.channel.send('**Please type the reason of the ticket**');
        };
                if(!support) {
                    return message.channel.send('** Please Make a role Called: `Support Team` **');
                };
            if(!ticketsStation) {
    ...
    if(message.content.startsWith(prefix + 'close')) {
        ...
        if(!message.channel.name.startsWith("ticket")) {
            return;
                ...
                let embed = new Discord.RichEmbed()
                    .setAuthor("Type The Command again you have 20seconds")
                    .setColor("RANDOM");
                    message.channel.sendEmbed(embed) .then(codes => {
                        ...
                        .then((collect) => {
                            ...
                            codes.delete()
                                .then(message.channel.send('**Has been cancelled**')) .then((c) => {
                                    c.delete(4000);
                                })
